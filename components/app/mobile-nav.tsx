...
export function MobileTopBar() {
  return (
    <header className="pt-safe sticky top-0 z-30 border-b border-border bg-card/90 backdrop-blur lg:hidden">
...
export function MobileTabBar() {
  ...
  return (
    <nav className="pb-safe fixed inset-x-0 bottom-0 z-40 border-t border-border bg-card/95 backdrop-blur lg:hidden">
