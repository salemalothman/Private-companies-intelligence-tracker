...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // zoom 95→100 alongside the fade gives the dialog spatial provenance
        // (it "surfaces" rather than blinks in); exits mirror softer. The
        // global prefers-reduced-motion block collapses it to instant.
        // The slide-from 1/2 / 48% values re-supply the centering translate
